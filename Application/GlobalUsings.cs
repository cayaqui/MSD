...
global using Application.Interfaces.Contracts;
global using Application.Services.Base;
global using Core.DTOs.Contracts.ContractMilestones;
global using Core.Enums.Contracts;
global using Domain.Entities.Contracts.Core;
global using InvalidOperationException = Application.Common.Exceptions.InvalidOperationException;