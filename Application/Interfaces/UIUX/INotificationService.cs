...
public interface INotificationService
{
    ...
    Task CreateProjectNotificationAsync(Guid projectId, string title, string message, NotificationType type = NotificationType.Info, ProjectNotificationCategory category = ProjectNotificationCategory.General);
