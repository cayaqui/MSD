...
public class Invoice : BaseEntity, IAuditable, ISoftDelete
{
    ...
    public Money GetGrossAmountMoney() => new(GrossAmount, Currency);

    public Money GetNetAmountMoney() => new(NetAmount, Currency);

    public Money GetTotalAmountMoney() => new(TotalAmount, Currency);

    public Money GetPaidAmountMoney() => new(PaidAmount, Currency);

    public Money GetOutstandingAmountMoney() => new(TotalAmount - PaidAmount, Currency);
    ...
    public DateRange GetPeriodRange() => new(PeriodStartDate, PeriodEndDate);
}
