...
/// </summary>
public class CostItem : BaseEntity, IAuditable
{
    // Basic Information
    ...
    public void RecordActualCost(decimal amount, DateTime transactionDate, string? referenceType, string? referenceNumber)
    {
        ActualCost = amount;
...
/// <summary>
/// Planning Package for future work not yet detailed
/// </summary>
public class PlanningPackage : BaseEntity, IAuditable
{
    // Basic Information
    public Guid ControlAccountId { get; private set; }
    ...
    public void ConvertToWorkPackage()
    {
        IsConverted = true;
