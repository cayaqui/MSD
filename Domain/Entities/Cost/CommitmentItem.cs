...
public class CommitmentItem : BaseEntity, IAuditable, ISoftDelete
{
    ...
    public Money GetUnitPriceMoney() => new(UnitPrice, Currency);
    public Money GetTotalPriceMoney() => new(TotalPrice, Currency);
    public Money GetNetAmountMoney() => new(NetAmount, Currency);
    public Money GetLineTotalMoney() => new(LineTotal, Currency);
