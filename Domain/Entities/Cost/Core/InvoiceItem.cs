...
public class InvoiceItem : BaseEntity, IAuditable
{
    ...
    public Guid? CommitmentItemId { get; private set; }
    public CommitmentItem? CommitmentItem { get; private set; }
    ...
    public void LinkToCommitmentItem(Guid commitmentItemId)
    {
        CommitmentItemId = commitmentItemId;
        UpdatedAt = DateTime.UtcNow;
    }
